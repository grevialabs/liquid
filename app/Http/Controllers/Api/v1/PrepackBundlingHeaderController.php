...
class PrepackBundlingHeaderController extends ApiController {
    ...
    */
    ...
    public $primary_key = 'prepack_id';
    public $list_column = array('outbound_delivery', 'site_created_on', 'status_prepack', 'conv_uom' ,
    'combine_qty', 'user_id','status', 'created_at', 'created_by','created_ip',

...
use App\Models\ArticleAttributeModel;

class ArticleAttributeController extends ApiController {
	...
	|
    */
    public $table = 'ms_article_attribute';
    public $primary_key = 'article_attribute_id';
	public $list_column = array('article_attribute_id','attribute_name','chamber_sync_flag','field_sync', 'status', 'created_at', 'created_by','created_ip','updated_at','updated_by','updated_ip');
	...
	public function get_list_status()
	{
		...
		// $log = ArticleModel::where('article_attribute_id',3)
	...
	public function get()
	{
		...
		if (isset($attr['article_attribute_id']) && $attr['article_attribute_id'] != '') {
			$q.= ' AND article_attribute_id = '.$attr['article_attribute_id'];
		}
	...
	public function get_list()
	{
		...
		if (isset($attr['keyword']) && $attr['keyword'] != '') {
			$q.= ' AND ( ';
			$q.= ' attribute_name LIKE '.replace_quote($attr['keyword'],'like');
			$q.= ')';
        }

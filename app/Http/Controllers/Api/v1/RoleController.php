...
class RoleController extends ApiController {
    ...
    */
    ...
    public $list_column = array('role_id','role_name','chamber_sync_flag','status', 'created_at', 'created_by','created_ip','updated_at','updated_by','updated_ip');
	...
	public function get_list_status()
	{
		...
		// $log = ArticleModel::where('role_id',3)
	...
	public function get_list()
	{
		...
		if (isset($attr['keyword']) && $attr['keyword'] != '') {
			...
			$q.= ' OR role_name LIKE '.replace_quote($attr['keyword'],'like');
			$q.= ')';
        }
		...
		if (isset($attr['role_name']) && $attr['role_name'] != '') {
			$q.= ' AND role_name = '.replace_quote($attr['role_name']);
        }

...
class ReasonTypeController extends ApiController {
    ...
    */
    ...
    public $list_column = array('reason_type_id','site_id','article_id','attribute','attribute_value','status', 'created_at', 'created_by','created_ip','updated_at','updated_by','updated_ip');

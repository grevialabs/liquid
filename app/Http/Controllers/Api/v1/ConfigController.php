...
class ConfigController extends ApiController {
	...
	|
    */
    public $table = 'ms_config';
    public $primary_key = 'config_id';
    public $list_column = array('config_id','site_id', 'config_name', 'config_value','status', 'created_at', 'created_by','created_ip','updated_at','updated_by','updated_ip');
	...
	public function get_list_status()
	{
		...
		// $log = ArticleModel::where('config_id',3)
	...
	public function get()
	{
		...
		if (isset($attr['config_id']) && $attr['config_id'] != '') {
			$q.= ' AND config_id = '.$attr['config_id'];
		}
	...
	public function get_list()
	{
		...
		if (isset($attr['keyword']) && $attr['keyword'] != '') {
			...
			$q.= ' OR config_name LIKE '.replace_quote($attr['keyword'],'like');
			$q.= ' OR config_value LIKE '.replace_quote($attr['keyword'],'like');
			$q.= ')';
        }

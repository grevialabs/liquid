...
class ArticlePoController extends ApiController {
    ...
    */
    ...
    public $list_column = array('article_po_id','site_id', 'article', 'customer_article','description','po_blanket_number', 'po_blanket_qty', 'po_created_date','status', 'created_at', 'created_by','created_ip','updated_at','updated_by','updated_ip');

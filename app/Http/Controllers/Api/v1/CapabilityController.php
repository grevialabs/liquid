...
class CapabilityController extends ApiController {
	...
	|
    */
    public $table = 'ms_capability';
    public $primary_key = 'capability_id';
    public $list_column = array('capability_id','capability','status', 'created_at', 'created_by','created_ip','updated_at','updated_by','updated_ip');
	...
	public function get_list()
	{
		...
		if (isset($attr['keyword']) && $attr['keyword'] != '') {
			$q.= ' AND ( ';
			$q.= ' capability_id LIKE '.replace_quote($attr['keyword'],'like');
			$q.= ' OR capability LIKE '.replace_quote($attr['keyword'],'like');
			$q.= ')';
        }
		...
		if (isset($attr['capability']) && $attr['capability'] != '') {
			$q.= ' AND capability = '.replace_quote($attr['capability']);
        }
